...
> **v4.3.5 · Community Edition · Oracle**
>
...
├── RELEASE_NOTES_v4.3.5.md   # release notes for this version
├── LICENSE
├── NOTICE
...
```bash
"$PYTHON_BIN" scripts/deploy_oracle.py <user> <pass> <dsn> scripts/deploy/1_schema.sql
```
