...
The v4.4.13 Development Candidate adds a knowledge-grounded Portal. It checks
...
product-knowledge topics for Oracle, PostgreSQL, and YashanDB. This candidate
still requires independent human review and is not a public release.
...
├── RELEASE_NOTES_v4.4.13.md   # release notes for this version
├── LICENSE
├── NOTICE
...
```bash
bash scripts/install_platform.sh initialize --version v4.4.13 --database oracle --edition <community|enterprise> --config config.json
```
