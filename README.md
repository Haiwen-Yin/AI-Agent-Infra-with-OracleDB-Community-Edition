...
> **v4.4.11 · Community Edition · Oracle**
>
...
```bash
bash scripts/install_platform.sh initialize --version v4.4.11 --database oracle --edition <community|enterprise> --config config.json
```
