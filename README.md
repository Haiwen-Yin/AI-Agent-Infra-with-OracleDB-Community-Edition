...
├── RELEASE_NOTES_v4.4.14.md   # release notes for this version
├── LICENSE
├── NOTICE
...
```bash
bash scripts/install_platform.sh initialize --version v4.4.14 --database oracle --edition <community|enterprise> --config config.json
```
