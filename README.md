...
> **v4.4.12 · Community Edition · Oracle**
>
...
```bash
bash scripts/install_platform.sh initialize --version v4.4.12 --database oracle --edition <community|enterprise> --config config.json
```
