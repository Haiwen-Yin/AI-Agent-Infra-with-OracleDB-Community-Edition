#!/bin/bash
# ============================================================================
# AI Agent Infra v3.4.0 - Community Edition - Web Server Control Script
...
do_status() {
    load_env
    echo -e "${BLUE}========================================${NC}"
    echo -e "${BLUE}  AI Agent Infra v3.4.0 - Community${NC}"
    echo -e "${BLUE}========================================${NC}"
    echo ""
    if is_running; then
        local pid=$(get_pid)
...
case "${1:-}" in
    ...
    log)     do_log ;;
    *)
        echo "AI Agent Infra v3.4.0 - Community Edition - Web Server Control"
        echo ""
