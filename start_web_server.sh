#!/usr/bin/env bash
# Chuanxu v4.4.13 - AI Agent Infra v4.4.13 - Oracle Community unified FastAPI/Uvicorn server controller.
...
export AI_AGENT_RELEASE_DATE="2026-09-05"
...
start_server() {
  ...
  echo "Starting Chuanxu v4.4.13 ($DB_DIALECT, $PROFILE) on $HOST:$PORT"
