#!/usr/bin/env bash
# Chuanxu v4.3.2 - AI Agent Infra v4.3.2 - {{EDITION_LABEL}} unified FastAPI/Uvicorn server controller.
...
export AI_AGENT_RELEASE_DATE="2026-08-01"
...
start_server() {
  ...
  echo "Starting Chuanxu v4.3.2 ($DB_DIALECT, $PROFILE) on $HOST:$PORT"
