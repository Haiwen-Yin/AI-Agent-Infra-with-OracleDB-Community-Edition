#!/usr/bin/env bash
# Chuanxu v4.4.14 - AI Agent Infra v4.4.14 - Oracle Community unified FastAPI/Uvicorn server controller.
...
export AI_AGENT_RELEASE_DATE="2026-09-13"
...
start_server() {
  ...
  echo "Starting Chuanxu v4.4.14 ($DB_DIALECT, $PROFILE) on $HOST:$PORT"
