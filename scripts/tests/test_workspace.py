"""Oracle Memory System v2.3.2 - Workspace API Tests"""
...
def test_create_workspace_user_owned():
    ...
    assert isinstance(user_ws_id, str)
    assert user_ws_id.startswith('WS_')
...
def test_create_workspace_system_owned():
    ...
    assert isinstance(system_ws_id, str)
    assert system_ws_id.startswith('WS_')
...
def test_create_handoff_session():
    ...
    assert isinstance(handoff_session_id, str)
