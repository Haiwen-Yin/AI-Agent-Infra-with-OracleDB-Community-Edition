"""AI Agent Infra v3.3.0 - Rich Test Data Seeder
...
DOMAINS = {
    "database": [
        ...
        ("JSON-Relational Duality Views", "JRD updatable views enabling document API on relational tables with etag-based optimistic concurrency control in Oracle 23ai", "architecture", 9),
...
def main():
    print("=" * 60)
    print("AI Agent Infra v3.3.0 - Rich Test Data Seeder")
    print("=" * 60)
