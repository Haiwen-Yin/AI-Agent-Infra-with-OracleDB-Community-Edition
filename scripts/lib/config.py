"""AI Agent Infra v4.0.0 - Enterprise Edition - Unified Configuration Manager
...
def load_config() -> Config:
    ...
    srv = ServerConfig(
        ...
        session_timeout=int(srv_raw.get("session_timeout") or sec_raw.get("session_timeout") or os.environ.get("MEMORY_SESSION_TIMEOUT", ServerConfig.session_timeout)),
    )
