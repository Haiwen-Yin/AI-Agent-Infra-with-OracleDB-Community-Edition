-- ============================================================
-- AI Agent Infra v3.10.2 - Enterprise Edition - Phase 2: PL/SQL API Packages
-- ============================================================
...
CREATE OR REPLACE PACKAGE BODY EMBEDDING_MANAGER AS
    ...
    FUNCTION generate_embedding(p_text IN VARCHAR2) RETURN CLOB IS
        l_url   VARCHAR2(4000) := get_config('embedding_url', get_config('embedding_url'));
...
PROMPT ============================================================
PROMPT AI Agent Infra v3.10.2 - Enterprise Edition API Deployment Complete
PROMPT ============================================================
