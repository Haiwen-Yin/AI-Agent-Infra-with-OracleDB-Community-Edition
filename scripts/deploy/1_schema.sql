PROMPT ============================================================
PROMPT AI Agent Infra v4.4.10 - Schema Deployment
PROMPT ============================================================
...
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        NULL; -- SYSTEM_CONFIG exists but no schema_version, proceed
    WHEN OTHERS THEN
        IF SQLCODE = -20001 THEN
            RAISE; -- Re-raise our custom error
        END IF;
        -- Other errors (table not exists etc), proceed with deployment
        NULL;
END;
/
...
PROMPT ============================================================
PROMPT 8b. LDAP_CONFIG (Non-Partitioned) [NEW v3.1.0 ENT]
PROMPT ============================================================

CREATE TABLE LDAP_CONFIG (
    CONFIG_ID          VARCHAR2(64)  PRIMARY KEY,
    SERVER_URL         VARCHAR2(512) NOT NULL,
    BASE_DN            VARCHAR2(512) NOT NULL,
    BIND_DN            VARCHAR2(512),
    BIND_CREDENTIAL    VARCHAR2(1024) NOT NULL,
    USER_FILTER        VARCHAR2(512) DEFAULT '(uid={username})' NOT NULL,
    GROUP_FILTER       VARCHAR2(512) DEFAULT '(memberUid={username})' NOT NULL,
    USE_TLS            VARCHAR2(1)   DEFAULT 'Y' NOT NULL,
    TLS_VALIDATE       VARCHAR2(1)   DEFAULT 'Y' NOT NULL,
    SYNC_INTERVAL_MIN  NUMBER(6,0)   DEFAULT 60 NOT NULL,
    GROUP_ROLE_MAPPING JSON,
    STATUS             VARCHAR2(32)  DEFAULT 'ACTIVE' NOT NULL,
    LAST_SYNC_AT       TIMESTAMP,
    CREATED_AT         TIMESTAMP     DEFAULT SYSTIMESTAMP NOT NULL,
    UPDATED_AT         TIMESTAMP     DEFAULT SYSTIMESTAMP NOT NULL,
    CONSTRAINT CK_LC_STATUS CHECK (STATUS IN ('ACTIVE','INACTIVE','TESTING')),
    CONSTRAINT CK_LC_TLS CHECK (USE_TLS IN ('Y','N')),
    CONSTRAINT CK_LC_TLS_VAL CHECK (TLS_VALIDATE IN ('Y','N'))
);

PROMPT ============================================================
PROMPT 8c. LDAP_SYNC_LOG (RANGE Partitioned) [NEW v3.1.0 ENT]
PROMPT ============================================================
...
CREATE TABLE LDAP_SYNC_LOG (
    ...
    USERS_SYNCED  NUMBER(8,0)   DEFAULT 0 NOT NULL,
    GROUPS_SYNCED NUMBER(8,0)   DEFAULT 0 NOT NULL,
    ERROR_MESSAGE VARCHAR2(4000),
    SYNC_TIME     TIMESTAMP     DEFAULT SYSTIMESTAMP NOT NULL,
    DURATION_SEC  NUMBER(8,2),
    CONSTRAINT CK_LSL_STATUS CHECK (STATUS IN ('SUCCESS','PARTIAL','FAILED')),
    CONSTRAINT CK_LSL_TYPE CHECK (SYNC_TYPE IN ('FULL','INCREMENTAL','USER_LOOKUP','GROUP_LOOKUP','TEST'))
) PARTITION BY RANGE (SYNC_TIME)
(
    PARTITION P_202605 VALUES LESS THAN (TO_DATE('2026-06-01','YYYY-MM-DD')),
    PARTITION P_202606 VALUES LESS THAN (TO_DATE('2026-07-01','YYYY-MM-DD')),
    PARTITION P_202607 VALUES LESS THAN (TO_DATE('2026-08-01','YYYY-MM-DD')),
    PARTITION P_202608 VALUES LESS THAN (TO_DATE('2026-09-01','YYYY-MM-DD')),
    PARTITION P_MAX    VALUES LESS THAN (MAXVALUE)
);

ALTER TABLE LDAP_SYNC_LOG ADD CONSTRAINT UK_LSL_ID UNIQUE (LOG_ID);
...
CREATE TABLE SKILL_ACCESS_TOKEN (
    ...
    AGENT_ID             VARCHAR2(64)  NOT NULL,
    SESSION_ID           VARCHAR2(64),
    RESOURCE_URL         VARCHAR2(2048),
    EXPIRES_AT           TIMESTAMP     NOT NULL,
    IS_CONSUMED          VARCHAR2(1)   DEFAULT 'N' NOT NULL,
    CONSUMED_AT          TIMESTAMP,
    CREATED_AT           TIMESTAMP     DEFAULT SYSTIMESTAMP NOT NULL,
    DOWNLOAD_TOKEN       VARCHAR2(128),
    DOWNLOAD_EXPIRES_AT  TIMESTAMP,
    CONSTRAINT FK_SAT_SKILL FOREIGN KEY (SKILL_ID) REFERENCES ENTITIES(ENTITY_ID),
    CONSTRAINT FK_SAT_AGENT FOREIGN KEY (AGENT_ID) REFERENCES AGENT_REGISTRY(AGENT_ID),
    CONSTRAINT CK_SAT_CONSUMED CHECK (IS_CONSUMED IN ('Y','N'))
);
...
CREATE TABLE CONTEXT_AUDIT_LOG (
    AUDIT_ID         VARCHAR2(64)  DEFAULT SYS_GUID() PRIMARY KEY,
    ENTITY_ID        VARCHAR2(64)  NOT NULL,
    ENTITY_TYPE      VARCHAR2(32)  NOT NULL,
    AUDIT_TYPE       VARCHAR2(32)  NOT NULL,
    RULE_ID          VARCHAR2(64),
    SIMILARITY_SCORE NUMBER(5,4),
    THRESHOLD_SCORE  NUMBER(5,4),
    VIOLATION_DETAIL VARCHAR2(4000),
    AGENT_ID         VARCHAR2(64),
    SESSION_ID       VARCHAR2(64),
    WORKSPACE_ID     VARCHAR2(64),
    ...
    CREATED_AT       TIMESTAMP     DEFAULT SYSTIMESTAMP NOT NULL,
    CONSTRAINT CK_CAL_AUDIT_TYPE CHECK (AUDIT_TYPE IN (
        'RULE_VIOLATION','CONTEXT_SIMILARITY','IDLE_PATTERN','ACCESS_ANOMALY','DATA_LEAK',
        'EFFICIENCY','RELEVANCE','TOKEN_WASTE','ANOMALY','IDLE'
    )),
    CONSTRAINT CK_CAL_RESOLUTION CHECK (RESOLUTION_STATUS IN (
        'OPEN','ACKNOWLEDGED','RESOLVED','FALSE_POSITIVE','ESCALATED'
    ))
)
PARTITION BY RANGE (CREATED_AT) (
    PARTITION P_CAL_2025 VALUES LESS THAN (TO_DATE('2026-01-01','YYYY-MM-DD')),
    PARTITION P_CAL_2026 VALUES LESS THAN (TO_DATE('2027-01-01','YYYY-MM-DD')),
    PARTITION P_CAL_2027 VALUES LESS THAN (TO_DATE('2028-01-01','YYYY-MM-DD')),
    PARTITION P_CAL_MAX VALUES LESS THAN (MAXVALUE)
);
...
CREATE TABLE CONTEXT_AUDIT_RULES (
    RULE_ID       VARCHAR2(64)  DEFAULT SYS_GUID() PRIMARY KEY,
    RULE_NAME     VARCHAR2(128) NOT NULL UNIQUE,
    ...
    CREATED_AT    TIMESTAMP     DEFAULT SYSTIMESTAMP NOT NULL,
    UPDATED_AT    TIMESTAMP     DEFAULT SYSTIMESTAMP NOT NULL,
    CONSTRAINT CK_CAR_RULE_TYPE CHECK (RULE_TYPE IN (
        'ACCESS_PATTERN','DATA_FLOW','IDLE_DETECTION','CROSS_BOUNDARY','THRESHOLD'
    )),
    CONSTRAINT CK_CAR_SEVERITY CHECK (SEVERITY IN ('LOW','MEDIUM','HIGH','CRITICAL')),
    CONSTRAINT CK_CAR_ENABLED CHECK (IS_ENABLED IN ('Y','N'))
);

PROMPT ============================================================
PROMPT 25. LOOP_META (Reference Partitioned) [NEW v3.7.5]
PROMPT ============================================================
...
PROMPT ============================================================
PROMPT 26. LOOP_RUNS (Partitioned by LIST + RANGE) [NEW v3.7.5]
PROMPT ============================================================
...
PROMPT ============================================================
PROMPT 27. LOOP_ITERATIONS (Reference Partitioned) [NEW v3.7.5]
PROMPT ============================================================
...
PROMPT ============================================================
PROMPT 28. LOOP_HOOKS (Non-Partitioned) [NEW v3.7.5]
PROMPT ============================================================
...
PROMPT ============================================================
PROMPT 29. LOOP_AUDIT (Range Partitioned) [NEW v3.7.5 ENT]
PROMPT ============================================================

CREATE TABLE LOOP_AUDIT (
    ...
    ACTION_DETAIL JSON,
    CREATED_AT    TIMESTAMP      DEFAULT SYSTIMESTAMP NOT NULL,
    CONSTRAINT PK_LOOP_AUDIT PRIMARY KEY (AUDIT_ID, CREATED_AT),
    CONSTRAINT FK_LA_LOOP FOREIGN KEY (LOOP_ID) REFERENCES ENTITIES(ENTITY_ID) ON DELETE SET NULL,
    CONSTRAINT FK_LA_RUN FOREIGN KEY (RUN_ID) REFERENCES LOOP_RUNS(RUN_ID) ON DELETE SET NULL,
    CONSTRAINT FK_LA_COLLAB FOREIGN KEY (COLLAB_GROUP_ID) REFERENCES COLLAB_GROUPS(GROUP_ID) ON DELETE SET NULL,
...
(
    PARTITION P_LA_VALUES VALUES LESS THAN (MAXVALUE)
);
...
CREATE INDEX IDX_AR_PORTAL_NODE ON AGENT_REGISTRY(PORTAL_NODE_ID, STATUS);
CREATE INDEX IDX_AR_CREATED_BY ON AGENT_REGISTRY(CREATED_BY_AGENT_ID);

CREATE INDEX IDX_LC_STATUS ON LDAP_CONFIG(STATUS);
CREATE INDEX IDX_LSL_TYPE ON LDAP_SYNC_LOG(SYNC_TYPE) LOCAL;
CREATE INDEX IDX_LSL_TIME ON LDAP_SYNC_LOG(SYNC_TIME) LOCAL;
...
CREATE INDEX IDX_SAT_SKILL ON SKILL_ACCESS_TOKEN(SKILL_ID);
CREATE INDEX IDX_SAT_AGENT ON SKILL_ACCESS_TOKEN(AGENT_ID);
CREATE INDEX IDX_SAT_EXPIRES ON SKILL_ACCESS_TOKEN(EXPIRES_AT);
CREATE INDEX IDX_SAT_CONSUMED ON SKILL_ACCESS_TOKEN(IS_CONSUMED);
CREATE INDEX IDX_SAT_DL_TOKEN ON SKILL_ACCESS_TOKEN(DOWNLOAD_TOKEN);

CREATE INDEX IDX_CAL_ENTITY ON CONTEXT_AUDIT_LOG(ENTITY_ID) LOCAL;
CREATE INDEX IDX_CAL_TYPE ON CONTEXT_AUDIT_LOG(AUDIT_TYPE) LOCAL;
CREATE INDEX IDX_CAL_AGENT ON CONTEXT_AUDIT_LOG(AGENT_ID) LOCAL;
CREATE INDEX IDX_CAL_RESOLUTION ON CONTEXT_AUDIT_LOG(RESOLUTION_STATUS);
CREATE INDEX IDX_CAL_CREATED ON CONTEXT_AUDIT_LOG(CREATED_AT) LOCAL;

CREATE INDEX IDX_CAR_TYPE ON CONTEXT_AUDIT_RULES(RULE_TYPE);
CREATE INDEX IDX_CAR_SEVERITY ON CONTEXT_AUDIT_RULES(SEVERITY);
CREATE INDEX IDX_CAR_ENABLED ON CONTEXT_AUDIT_RULES(IS_ENABLED);
...
CREATE INDEX IDX_LA_LOOP ON LOOP_AUDIT(LOOP_ID) LOCAL;
CREATE INDEX IDX_LA_RUN ON LOOP_AUDIT(RUN_ID) LOCAL;
CREATE INDEX IDX_LA_ACTION ON LOOP_AUDIT(ACTION_TYPE) LOCAL;
CREATE INDEX IDX_LA_CREATED ON LOOP_AUDIT(CREATED_AT) LOCAL;
CREATE INDEX IDX_LA_BY ON LOOP_AUDIT(ACTION_BY);

CREATE INDEX IDX_TLB_STEP ON TASK_LOOP_BINDING(STEP_ID);
CREATE INDEX IDX_TLB_LOOP ON TASK_LOOP_BINDING(LOOP_ID);

CREATE INDEX IDX_TS_LOOP ON TASK_STEPS(LOOP_ID);
CREATE INDEX IDX_TS_COMPLETION ON TASK_STEPS(STEP_COMPLETION_TYPE);

CREATE INDEX IDX_LR_PARENT_RUN ON LOOP_RUNS(PARENT_RUN_ID);

CREATE INDEX IDX_LM_SPEC ON LOOP_META(SPEC_ID);
CREATE INDEX IDX_LM_PARENT_LOOP ON LOOP_META(PARENT_LOOP_ID);
CREATE INDEX IDX_LM_COLLAB ON LOOP_META(COLLAB_GROUP_ID);

CREATE INDEX IDX_LA_COLLAB ON LOOP_AUDIT(COLLAB_GROUP_ID);
...
CREATE INDEX IDX_APPROVAL_STATUS ON APPROVAL_REQUESTS(APPROVAL_STATUS, CREATED_AT DESC);
...
BEGIN
    CTXSYS.CTX_DDL.DROP_PREFERENCE('ENTITIES_MCD');
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    CTXSYS.CTX_DDL.CREATE_PREFERENCE('ENTITIES_MCD', 'MULTI_COLUMN_DATASTORE');
    CTXSYS.CTX_DDL.SET_ATTRIBUTE('ENTITIES_MCD', 'COLUMNS', 'TITLE, CONTENT');
END;
/
...
DECLARE
    v_preference_count NUMBER;
    v_opstatus VARCHAR2(16);
BEGIN
    ...
    IF v_preference_count <> 1 THEN
        RAISE_APPLICATION_ERROR(-20031,
            'Oracle Text preference ENTITIES_MCD was not created. Run 0_oracle_text_prerequisites.sql as SYSDBA first.');
    END IF;

    SELECT DOMIDX_OPSTATUS INTO v_opstatus
    FROM USER_INDEXES
    WHERE INDEX_NAME = 'ENTITIES_SEARCH_CTX';
    IF UPPER(v_opstatus) <> 'VALID' THEN
        RAISE_APPLICATION_ERROR(-20032,
            'Oracle Text index ENTITIES_SEARCH_CTX is not operational: ' || NVL(v_opstatus, 'NULL'));
    END IF;
END;
/
...
PROMPT ============================================================
PROMPT AI Agent Infra v4.4.10 - Schema Deployment Complete
PROMPT ============================================================
