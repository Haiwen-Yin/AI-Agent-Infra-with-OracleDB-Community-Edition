PROMPT ============================================================
PROMPT AI Agent Infra v3.7.0 - Community Edition - Schema Deployment
PROMPT ============================================================
...
CREATE TABLE CONTEXT_BRANCHES (
    ...
    CREATED_AT       TIMESTAMP     DEFAULT SYSTIMESTAMP NOT NULL,
    CLOSED_AT        TIMESTAMP,
    CONSTRAINT FK_CB_WORKSPACE FOREIGN KEY (WORKSPACE_ID) REFERENCES WORKSPACES(WORKSPACE_ID) ON DELETE CASCADE,
    CONSTRAINT FK_CB_PARENT FOREIGN KEY (PARENT_BRANCH_ID) REFERENCES CONTEXT_BRANCHES(BRANCH_ID) ON DELETE SET NULL,
    CONSTRAINT FK_CB_FORK_CTX FOREIGN KEY (FORK_CONTEXT_ID) REFERENCES WORKSPACE_CONTEXT(CONTEXT_ID) ON DELETE SET NULL,
    CONSTRAINT FK_CB_AGENT FOREIGN KEY (AGENT_ID) REFERENCES AGENT_REGISTRY(AGENT_ID),
    CONSTRAINT FK_CB_SRC_AGENT FOREIGN KEY (SOURCE_AGENT_ID) REFERENCES AGENT_REGISTRY(AGENT_ID),
...
PROMPT ============================================================
PROMPT 24. LOOP_META (Reference Partitioned) [NEW v3.7.0]
PROMPT ============================================================
...
PROMPT ============================================================
PROMPT 25. LOOP_RUNS (Partitioned by LIST + RANGE) [NEW v3.7.0]
PROMPT ============================================================
...
ALTER TABLE LOOP_RUNS ADD CONSTRAINT UK_LOOP_RUNS_ID UNIQUE (RUN_ID);
ALTER TABLE LOOP_RUNS ENABLE ROW MOVEMENT;

PROMPT ============================================================
PROMPT 26. LOOP_ITERATIONS (Reference Partitioned) [NEW v3.7.0]
PROMPT ============================================================
...
PROMPT ============================================================
PROMPT 27. LOOP_HOOKS (Non-Partitioned) [NEW v3.7.0]
PROMPT ============================================================
...
INSERT INTO SYSTEM_CONFIG (CONFIG_KEY, CONFIG_VALUE, DESCRIPTION) VALUES ('schema_version', '3.7.0', 'Current schema version');
...
PROMPT ============================================================
PROMPT AI Agent Infra v3.7.0 - Community Edition Schema Deployment Complete
PROMPT ============================================================
