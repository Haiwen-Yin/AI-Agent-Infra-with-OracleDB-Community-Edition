# AI Agent Infra with OracleDB — 社区版 v3.9.0

**版本**: v3.9.0 | **日期**: 2026-07-05 | **作者**: 尹海文 | **许可**: Apache License 2.0

> v3.9.0 AI Agent生态连接层：新增MCP Server（10个工具，stdio+SSE双模式），SSE流式输出，Human-in-the-Loop三级审批（步骤/循环/工具），Agent Protocol兼容端点，多模型路由。新增文件：mcp_server.py、approval_api.py、approvals.html。数据库：APPROVAL_REQUESTS表 + PAUSED状态 + 3列审批标记。
