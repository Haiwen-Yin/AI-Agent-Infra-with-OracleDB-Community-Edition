# AI Agent Infra with OracleDB — 社区版 v3.10.1

**版本**: v3.10.1 | **日期**: 2026-07-14 | **作者**: 尹海文 | **许可**: Apache License 2.0

> v3.10.1 离线部署支持：vendor/ 目录含30个cp314 wheels，install_offline.sh 一键安装，verify_deps.py 验证完整性。纯Python deploy_oracle.py 替代SQLcl部署工具（状态机解析PROMPT/DEFINE/&&///）。
