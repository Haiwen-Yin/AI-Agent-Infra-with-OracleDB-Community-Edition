# AI Agent Infra with OracleDB — 社区版 v3.7.2
...
| 版本 | 日期 | 里程碑 |
|------|------|--------|
| **v3.7.2** | 2026-06-19 | 文档一致性修正：LOOP_MANAGER ~33→~22、loop_api 32 公共函数、LOOP_CLEANUP 调度 Weekly Sunday 06:00、PG PL/SQL→PL/pgSQL 术语、ENTITIES 分区 7→8、SKILL_MANAGER 移除（COM）、评估类型 4→6、架构图对齐 |
...
> **L4 Deep Data Security 执行状态（v3.7.2）**
>
...
## 循环工程协同集成（Loop Engineering Collaborative Integration）[NEW v3.7.2]
...
## 七·五、循环工程（Loop Engineering）[NEW v3.7.2]
